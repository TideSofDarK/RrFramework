...
struct SCamera
{
    ...
    [[nodiscard]] Rr_Mat4 GetOrbitViewMatrix()
    {
        ...
        ViewMatrix = Rr_LookAt_RH(Eye, OrbitCenter, { 0.0f, 1.0f, 0.0f });
        return ViewMatrix;
    }

    [[nodiscard]] Rr_Mat4 GetFPViewMatrix()
    {
    ...
    Rr_GraphImage *DepthAttachmentHandle)
{
    ...
    UniformData.View = Rr_MulM4(Rr_VulkanMatrix(), Camera.GetOrbitViewMatrix());
