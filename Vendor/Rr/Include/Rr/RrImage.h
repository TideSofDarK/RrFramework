...
Rr_Image Rr_LoadPNG(Rr_Asset* Asset, Rr_Renderer* Renderer, VkImageUsageFlags Usage, b8 bMipMapped, VkImageLayout InitialLayout);
Rr_Image Rr_LoadEXRDepth(Rr_Asset* Asset, Rr_Renderer* Renderer);
