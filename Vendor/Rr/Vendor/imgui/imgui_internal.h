...
enum ImGuiNavHighlightFlags_
{
    ...
    ImGuiNavHighlightFlags_AlwaysDraw       = 1 << 2,       // DrawBuffer rectangular highlight if (g.NavId == id) _even_ when using the mouse.
...
struct ImGuiTableColumn
{
    ...
    ImGuiTableDrawChannelIdx DrawChannelFrozen;             // DrawBuffer channels for frozen rows (often headers)
    ImGuiTableDrawChannelIdx DrawChannelUnfrozen;           // DrawBuffer channels for unfrozen rows
