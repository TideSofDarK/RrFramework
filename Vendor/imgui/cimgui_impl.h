...
CIMGUI_API void ImGui_ImplSDL3_SetGamepadMode(
...
CIMGUI_API void ImGui_ImplVulkan_RenderDrawData(
...
CIMGUI_API bool ImGui_ImplVulkan_LoadFunctions(
...
CIMGUI_API void ImGui_ImplVulkanH_DestroyWindow(
    VkInstance instance,
    VkDevice device,
    ImGui_ImplVulkanH_Window *wnd,
    const VkAllocationCallbacks *allocator);
