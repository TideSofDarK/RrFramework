...
CIMGUI_API bool igBeginChild_Str(
    const char *str_id,
    const ImVec2 size,
    ImGuiChildFlags child_flags,
    ImGuiWindowFlags window_flags);
CIMGUI_API bool igBeginChild_ID(
    ImGuiID id,
    const ImVec2 size,
    ImGuiChildFlags child_flags,
    ImGuiWindowFlags window_flags);
...
CIMGUI_API bool igCombo_Str_arr(
    const char *label,
    int *current_item,
    const char *const items[],
    int items_count,
    int popup_max_height_in_items);
CIMGUI_API bool igCombo_Str(
    const char *label,
    int *current_item,
    const char *items_separated_by_zeros,
    int popup_max_height_in_items);
CIMGUI_API bool igCombo_FnStrPtr(
    const char *label,
    int *current_item,
...
CIMGUI_API bool igDragFloat4(
    ...
    const char *format,
    ImGuiSliderFlags flags);
CIMGUI_API bool igDragFloatRange2(
    const char *label,
    float *v_current_min,
    float *v_current_max,
    float v_speed,
...
CIMGUI_API bool igDragInt4(
    ...
    const char *format,
    ImGuiSliderFlags flags);
CIMGUI_API bool igDragIntRange2(
    const char *label,
    int *v_current_min,
    int *v_current_max,
    float v_speed,
...
CIMGUI_API bool igSliderFloat(
    ...
    const char *format,
    ImGuiSliderFlags flags);
CIMGUI_API bool igSliderFloat2(
    const char *label,
    float v[2],
    float v_min,
    float v_max,
    const char *format,
    ImGuiSliderFlags flags);
CIMGUI_API bool igSliderFloat3(
    const char *label,
    float v[3],
    float v_min,
    float v_max,
    const char *format,
    ImGuiSliderFlags flags);
CIMGUI_API bool igSliderFloat4(
    const char *label,
    float v[4],
    float v_min,
    float v_max,
...
CIMGUI_API bool igSliderInt4(
    ...
    const char *format,
    ImGuiSliderFlags flags);
CIMGUI_API bool igSliderScalar(
    const char *label,
    ImGuiDataType data_type,
    void *p_data,
    const void *p_min,
    ...
    const char *format,
    ImGuiSliderFlags flags);
CIMGUI_API bool igSliderScalarN(
    const char *label,
    ImGuiDataType data_type,
    void *p_data,
    int components,
    ...
    const char *format,
    ImGuiSliderFlags flags);
CIMGUI_API bool igVSliderFloat(
    const char *label,
    const ImVec2 size,
    float *v,
    float v_min,
...
CIMGUI_API bool igVSliderInt(
    ...
    const char *format,
    ImGuiSliderFlags flags);
CIMGUI_API bool igVSliderScalar(
    const char *label,
    const ImVec2 size,
    ImGuiDataType data_type,
    void *p_data,
...
CIMGUI_API bool igInputText(
    ...
    void *user_data);
CIMGUI_API bool igInputTextMultiline(
    const char *label,
    char *buf,
    size_t buf_size,
    const ImVec2 size,
    ...
    ImGuiInputTextCallback callback,
    void *user_data);
CIMGUI_API bool igInputTextWithHint(
    const char *label,
    const char *hint,
    char *buf,
    size_t buf_size,
...
CIMGUI_API bool igInputScalar(
    ...
    const char *format,
    ImGuiInputTextFlags flags);
CIMGUI_API bool igInputScalarN(
    const char *label,
    ImGuiDataType data_type,
    void *p_data,
    int components,
...
CIMGUI_API bool igSelectable_BoolPtr(
    const char *label,
    bool *p_selected,
...
CIMGUI_API bool igListBox_Str_arr(
    const char *label,
    int *current_item,
    const char *const items[],
    int items_count,
    int height_in_items);
CIMGUI_API bool igListBox_FnStrPtr(
    const char *label,
    int *current_item,
    const char *(*getter)(void *user_data, int idx),
    void *user_data,
    int items_count,
    int height_in_items);
CIMGUI_API void igPlotLines_FloatPtr(
    const char *label,
    const float *values,
    int values_count,
    int values_offset,
...
CIMGUI_API void igPlotLines_FnFloatPtr(
    ...
    float scale_max,
    ImVec2 graph_size);
CIMGUI_API void igPlotHistogram_FloatPtr(
    const char *label,
    const float *values,
    int values_count,
    int values_offset,
...
CIMGUI_API void igTableSetupColumn(
    const char *label,
    ImGuiTableColumnFlags flags,
...
CIMGUI_API ImGuiID
igDockSpace(ImGuiID dockspace_id, const ImVec2 size, ImGuiDockNodeFlags flags, const ImGuiWindowClass *window_class);
...
CIMGUI_API void igPushClipRect(
...
CIMGUI_API void igCalcTextSize(
    ImVec2 *pOut,
    const char *text,
    const char *text_end,
...
CIMGUI_API bool igDebugCheckVersionAndDataLayout(
...
CIMGUI_API void igGetAllocatorFunctions(
...
CIMGUI_API void ImDrawList_AddEllipseFilled(
    ...
    float rot,
    int num_segments);
CIMGUI_API void ImDrawList_AddText_Vec2(
    ImDrawList *self,
    const ImVec2 pos,
    ImU32 col,
...
CIMGUI_API const char *igImStristr(
    const char *haystack,
...
CIMGUI_API int igImTextStrFromUtf8(
    ImWchar *out_buf,
    int out_buf_size,
    const char *in_text,
...
CIMGUI_API void igImBezierCubicCalc(
    ImVec2 *pOut,
    const ImVec2 p1,
    const ImVec2 p2,
    const ImVec2 p3,
    const ImVec2 p4,
    float t);
CIMGUI_API void igImBezierCubicClosestPoint(
    ImVec2 *pOut,
    const ImVec2 p1,
    const ImVec2 p2,
    const ImVec2 p3,
...
CIMGUI_API void igImTriangleBarycentricCoords(
    const ImVec2 a,
    const ImVec2 b,
    const ImVec2 c,
    const ImVec2 p,
...
CIMGUI_API void ImGuiViewportP_CalcWorkRectSize(
    ImVec2 *pOut,
    ImGuiViewportP *self,
...
CIMGUI_API bool igIsWindowChildOf(
    ImGuiWindow *window,
...
CIMGUI_API void igFocusTopMostWindowUnderOne(
...
CIMGUI_API void igAddDrawListToDrawDataEx(
...
CIMGUI_API void igTranslateWindowsInViewport(
    ImGuiViewportP *viewport,
...
CIMGUI_API void igSetLastItemData(
    ImGuiID item_id,
...
CIMGUI_API bool igBeginChildEx(
    const char *name,
    ImGuiID id,
...
CIMGUI_API bool igBeginViewportSideBar(
    const char *name,
...
CIMGUI_API void igNavMoveRequestSubmit(
    ImGuiDir move_dir,
    ImGuiDir clip_dir,
    ImGuiNavMoveFlags move_flags,
    ImGuiScrollFlags scroll_flags);
CIMGUI_API void igNavMoveRequestForward(
    ImGuiDir move_dir,
    ImGuiDir clip_dir,
    ImGuiNavMoveFlags move_flags,
    ImGuiScrollFlags scroll_flags);
...
CIMGUI_API void igGetKeyMagnitude2d(
    ImVec2 *pOut,
    ImGuiKey key_left,
    ImGuiKey key_right,
    ImGuiKey key_up,
...
CIMGUI_API void igDockContextQueueDock(
    ImGuiContext *ctx,
    ImGuiWindow *target,
...
CIMGUI_API bool igDockContextCalcDropPosForDocking(
    ImGuiWindow *target,
    ImGuiDockNode *target_node,
...
CIMGUI_API ImGuiID igDockBuilderSplitNode(
    ImGuiID node_id,
    ImGuiDir split_dir,
...
CIMGUI_API int igTypingSelectFindMatch(
...
CIMGUI_API int igTypingSelectFindBestLeadingMatch(
    ...
    const char *(*get_item_name_func)(void *, int),
    void *user_data);
CIMGUI_API bool igBeginBoxSelect(
...
CIMGUI_API void igMultiSelectAddSetRange(
...
CIMGUI_API void igTableSetColumnSortDirection(
    int column_n,
...
CIMGUI_API void igTableAngledHeadersRowEx(
    ImGuiID row_id,
    float angle,
...
CIMGUI_API bool igBeginTableEx(
    const char *name,
    ImGuiID id,
    int columns_count,
    ImGuiTableFlags flags,
...
CIMGUI_API void igTabItemLabelAndCloseButton(
    ImDrawList *draw_list,
    const ImRect bb,
    ImGuiTabItemFlags flags,
...
CIMGUI_API void igRenderTextClipped(
...
CIMGUI_API void igRenderTextClippedEx(
    ImDrawList *draw_list,
    const ImVec2 pos_min,
    const ImVec2 pos_max,
    const char *text,
    ...
    const ImVec2 align,
    const ImRect *clip_rect);
CIMGUI_API void igRenderTextEllipsis(
    ImDrawList *draw_list,
    const ImVec2 pos_min,
    const ImVec2 pos_max,
    float clip_max_x,
...
CIMGUI_API void igRenderMouseCursor(
    ImVec2 pos,
    float scale,
...
CIMGUI_API void igRenderArrowPointingAt(
    ImDrawList *draw_list,
    ImVec2 pos,
    ImVec2 half_sz,
    ImGuiDir direction,
...
CIMGUI_API void igRenderRectFilledRangeH(
    ImDrawList *draw_list,
    const ImRect rect,
    ImU32 col,
    float x_start_norm,
...
CIMGUI_API bool igImageButtonEx(
    ImGuiID id,
...
CIMGUI_API bool igButtonBehavior(
    const ImRect bb,
    ImGuiID id,
    bool *out_hovered,
    bool *out_held,
...
CIMGUI_API bool igDragBehavior(
    ...
    const char *format,
    ImGuiSliderFlags flags);
CIMGUI_API bool igSliderBehavior(
    const ImRect bb,
    ImGuiID id,
    ImGuiDataType data_type,
    void *p_v,
...
CIMGUI_API int igDataTypeFormatString(
    char *buf,
    int buf_size,
    ImGuiDataType data_type,
    const void *p_data,
...
CIMGUI_API bool igDataTypeApplyFromText(
    const char *buf,
    ImGuiDataType data_type,
    void *p_data,
    const char *format,
...
CIMGUI_API bool igTempInputText(
    const ImRect bb,
    ImGuiID id,
    const char *label,
    char *buf,
    int buf_size,
    ImGuiInputTextFlags flags);
CIMGUI_API bool igTempInputScalar(
    const ImRect bb,
    ImGuiID id,
    const char *label,
    ImGuiDataType data_type,
...
CIMGUI_API void igShadeVertsLinearUV(
    ...
    const ImVec2 uv_b,
    bool clamp);
CIMGUI_API void igShadeVertsTransformPos(
    ImDrawList *draw_list,
    int vert_start_idx,
    int vert_end_idx,
...
CIMGUI_API void igDebugNodeDrawList(
    ImGuiWindow *window,
    ImGuiViewportP *viewport,
...
CIMGUI_API void igImFontAtlasBuildSetupFont(
    ImFontAtlas *atlas,
    ImFont *font,
