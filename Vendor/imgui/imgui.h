...
namespace ImGui
{
    ...
    // Background/Foreground DrawBuffer Lists
...
enum ImGuiTreeNodeFlags_
{
    ...
    ImGuiTreeNodeFlags_Selected             = 1 << 0,   // DrawBuffer as selected
    ImGuiTreeNodeFlags_Framed               = 1 << 1,   // DrawBuffer frame with background (e.g. for CollapsingHeader)
...
enum ImGuiTableFlags_
{
    ...
    ImGuiTableFlags_BordersInnerH              = 1 << 7,   // DrawBuffer horizontal borders between rows.
    ImGuiTableFlags_BordersOuterH              = 1 << 8,   // DrawBuffer horizontal borders at the top and bottom.
    ImGuiTableFlags_BordersInnerV              = 1 << 9,   // DrawBuffer vertical borders between columns.
    ImGuiTableFlags_BordersOuterV              = 1 << 10,  // DrawBuffer vertical borders on the left and right sides.
    ImGuiTableFlags_BordersH                   = ImGuiTableFlags_BordersInnerH | ImGuiTableFlags_BordersOuterH, // DrawBuffer horizontal borders.
    ImGuiTableFlags_BordersV                   = ImGuiTableFlags_BordersInnerV | ImGuiTableFlags_BordersOuterV, // DrawBuffer vertical borders.
    ImGuiTableFlags_BordersInner               = ImGuiTableFlags_BordersInnerV | ImGuiTableFlags_BordersInnerH, // DrawBuffer inner borders.
    ImGuiTableFlags_BordersOuter               = ImGuiTableFlags_BordersOuterV | ImGuiTableFlags_BordersOuterH, // DrawBuffer outer borders.
    ImGuiTableFlags_Borders                    = ImGuiTableFlags_BordersInner | ImGuiTableFlags_BordersOuter,   // DrawBuffer all borders.
...
// ImDrawCallback: DrawBuffer callbacks for advanced uses [configurable type: override in imconfig.h]
// NB: You most likely do NOT need to use draw callbacks just to create your own widget or customized UI rendering,
// you can poke into the draw list for that! DrawBuffer callback may be useful for example to:
...
// Special DrawBuffer callback value to request renderer backend to reset the graphics/render state.
...
struct ImDrawListSplitter
{
    ...
    ImVector<ImDrawChannel>     _Channels;   // DrawBuffer channels (not resized down so _Count might be < Channels.Size)
...
struct ImDrawList
{
    ...
    ImVector<ImDrawCmd>     CmdBuffer;          // DrawBuffer commands. Typically 1 command = 1 GPU draw call, unless the command is a callback.
