...
extern void *Rr_ArenaAlloc(Rr_Arena *Arena, size_t Size, size_t Align, size_t Count);

#define RR_ARENA_ALLOC_ONE(Arena, Size)          Rr_ArenaAlloc(Arena, Size, RR_SAFE_ALIGNMENT, 1)
#define RR_ARENA_ALLOC_COUNT(Arena, Size, Count) Rr_ArenaAlloc(Arena, Size, RR_SAFE_ALIGNMENT, Count)
