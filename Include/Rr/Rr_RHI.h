...
typedef enum
{
    ...
    /* R8G8B8 */
    RR_IMAGE_FORMAT_R8G8B8_UNORM,
    RR_IMAGE_FORMAT_R8G8B8_UINT,
    RR_IMAGE_FORMAT_R8G8B8_SINT,
    RR_IMAGE_FORMAT_R8G8B8_SRGB,
    /* B8G8R8 */
    RR_IMAGE_FORMAT_B8G8R8_UNORM,
    RR_IMAGE_FORMAT_B8G8R8_UINT,
    RR_IMAGE_FORMAT_B8G8R8_SINT,
    RR_IMAGE_FORMAT_B8G8R8_SRGB,
    /* R8G8B8A8 */
