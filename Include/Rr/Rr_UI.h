...
typedef enum
{
    ...
    RR_UI_WINDOW_FLAGS_NO_VERTICAL_SCROLLBAR_BIT = 1U << 2,
    RR_UI_WINDOW_FLAGS_NO_MOVE_BIT = 1U << 3,
    RR_UI_WINDOW_FLAGS_NO_BORDERS_BIT = 1U << 4,
    RR_UI_WINDOW_FLAGS_NO_COLLAPSE_BIT = 1U << 5,
    RR_UI_WINDOW_FLAGS_NO_CLOSE_BIT = 1U << 6,
    RR_UI_WINDOW_FLAGS_NO_BACKGROUND_BIT = 1U << 7,
    RR_UI_WINDOW_FLAGS_AUTO_RESIZE_BIT = 1U << 8,
    RR_UI_WINDOW_FLAGS_ESCAPE_CLOSES_BIT = 1U << 9,
    RR_UI_WINDOW_FLAGS_UNDOCKABLE_BIT = 1U << 10,
    RR_UI_WINDOW_FLAGS_TABS_BIT = 1U << 11,
