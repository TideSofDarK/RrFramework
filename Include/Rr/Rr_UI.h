...
typedef enum
{
    ...
    RR_UI_WINDOW_FLAGS_NO_VERTICAL_SCROLLBAR_BIT = (1 << 2),
    RR_UI_WINDOW_FLAGS_NO_MOVE_BIT = (1 << 3),
    RR_UI_WINDOW_FLAGS_NO_BORDERS_BIT = (1 << 4),
    RR_UI_WINDOW_FLAGS_NO_COLLAPSE_BIT = (1 << 5),
    RR_UI_WINDOW_FLAGS_NO_CLOSE_BIT = (1 << 6),
    RR_UI_WINDOW_FLAGS_NO_BACKGROUND_BIT = (1 << 7),
